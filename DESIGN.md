...
2. 単一インスタンス用の所有権を取得します。
3. OSアダプター、設定ストア、更新サービス、ViewModelを生成します。
4. 非表示のWPFフライアウトからウィンドウハンドルを作成します。
5. 通知領域アイコンを追加します。
6. 通知アイコンの近くへフライアウトを表示し、設定と現在のWindows電源状態を読み込みます。
7. 起動から20秒後に、インストール版だけ安定版の更新を確認します。
8. 終了要求では電源要求を解放し、通知領域アイコンを削除します。
9. 終了処理の一部が失敗しても、残りの解放処理を継続します。
